...
| Business Value | 70% non-adherence in home rehab, subscription per professional, three verticals on one engine | The landing at `/`, whose plain register states the case without jargon and whose metrics band carries the number; deck; `docs/INTENT.md` §3–§4 | partial — deck pending |
