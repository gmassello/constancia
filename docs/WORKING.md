...
Seventeen test files, 319 collected with no environment variable set. Every one of them passes
...
- **No comments**, except `ponytail:` markers naming a deliberate ceiling and its upgrade path.
  There are **68** in the code and they are the honest list of what was knowingly left simple:
