...
Every number the design prints is already true of this repo: 70% non-adherence (`INTENT.md` §3.1), three packs, 333 free STT hours, 177 tests.
...
```bash
uv run ruff check . && uv run pytest -q     # 177 tests, with no environment variable set
