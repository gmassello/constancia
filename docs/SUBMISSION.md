...
- [x] `make test` green — 314 tests, no environment variable set; the ones that need a database skip themselves
- [x] `make test` green against a real Postgres too — `make db` and `DATABASE_URL=…`: 314 passed, nothing skipped
